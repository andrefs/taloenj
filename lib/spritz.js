...
var _template = function(req,res,filename,args,status,headers){
    // Read file contents
    fs.readFile(filename, 'utf-8', function(err, fileContent){
        ...
        // Compile template and generate output
...
spritz.render = function(req,res, view, args){
    var file = views_folder+'/'+view+'.handlebars';

    return _template(req,res,file, args, 200, {});
};
